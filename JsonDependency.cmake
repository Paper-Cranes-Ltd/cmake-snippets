...
function(json_config_dependencies)
    ...
    if(DEPENDENCIES_RANGE_END GREATER 0)
        foreach(INDEX RANGE 0 "${DEPENDENCIES_RANGE_END}")
            ...
            string(JSON DEPENDENCY_CONDITION ERROR_VARIABLE CONDITION_MISSING GET "${DEPENDENCY_JSON}" "condition")
            ...
            if((NOT "${DEPENDENCY_CONDITION}" MATCHES "NOTFOUND$") AND (NOT ${DEPENDENCY_CONDITION}))
                message(STATUS "Skipping dependency: ${DEPENDENCY_NAME} - " ${DEPENDENCY_VERSION})
                continue()
            endif()
            ...
            if(RECURSE_SUBMODULES_MISSING)
                ...
                if(NOT SUBMODULES_MISSING)
                    ...
                    if(SUBMODULES_RANGE_END GREATER 0)
            ...
            if(NOT "${DEPENDENCY_OPTIONS}" MATCHES "NOTFOUND$")
                ...
                if(OPTIONS_RANGE_END GREATER 0)
